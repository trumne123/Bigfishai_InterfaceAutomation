filepath_variable_path = {'LinkedDataPath': './TestData/Linked_Data.yaml',
                          'DubbingInfoPath': './TestData/Linked_dubbing_info_data.yaml',
                          'ReadingShowCase': './Test_Data/ReadingShow_case/',
                          'DubbingShowCase': './Test_Data/DubbingShow_case/',
                          'RolePlayingCase': '../Test_Data/RolePlaying_case/',
                          'testData': './Test_Data/',
